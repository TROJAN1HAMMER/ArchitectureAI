    ...
    <div className="flex flex-col min-h-screen bg-zinc-50 dark:bg-zinc-950 w-full transition-colors">
      ...
      <div className="flex flex-1">
        ...
        <main className="flex-1 p-8 overflow-y-auto">
          <div className="max-w-7xl mx-auto bg-white dark:bg-zinc-900 rounded-xl border border-zinc-200 dark:border-zinc-700 p-8 shadow-sm dark:shadow-zinc-950 min-h-[calc(100vh-8rem)] transition-colors">
            {children}
          </div>
        </main>
      </div>
